...
async function generate() {
    ...
    console.log(url);
    try {
        const input = await getJson_1.getSwaggerJson(url);
        // JSON.parse(
        ...
        Object.entries(input.paths).forEach(([endPoint, value]) => {
            Object.entries(value).forEach(([method, options]) => {
                ...
                let contentType = Object.keys(((_a = options.requestBody) === null || _a === void 0 ? void 0 : _a.content) || {
                    "application/json": null,
                })[0];
                let accept = Object.keys(((_b = options.responses) === null || _b === void 0 ? void 0 : _b[200].content) || {
                    "application/json": null,
                })[0];
                let responses = getBodyContent((_c = options.responses) === null || _c === void 0 ? void 0 : _c[200]);
...
): Promise<SwaggerResponse<${responses ? utils_1.getTsType(responses) : "any"}>> {
...
`;
        ...
        if (!fs_1.existsSync("./config.ts")) {
            fs_1.writeFileSync("./config.ts", prettier_1.format(strings_1.CONFIG, { parser: "jsdoc-parser" }));
        }
    }
    catch (error) {
        console.log({ error });
